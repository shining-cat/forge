...
#
# Strategy: stub $COPILOT_DIR/scripts/forge-calendar.sh under a temp HOME with
...
# Build a sandbox HOME with $COPILOT_DIR/scripts/ and an optional fake calendar
...
mk_sandbox() {
  ...
  local sh="$home/.copilot/scripts/forge-calendar.sh"
