...
LOG_PATH = Path(os.environ.get("COPILOT_HOME", str(Path.home() / ".copilot"))) / "wellness-idle-log.json"
BINARY_PATH = Path(os.environ.get("COPILOT_HOME", str(Path.home() / ".copilot"))) / "bin" / "screen_state"
FORGE_CONF_PATH = Path(os.environ.get("COPILOT_HOME", str(Path.home() / ".copilot"))) / "forge.conf"
MAX_AGE_SECONDS = 7200  # 2 hours


def get_vault_path():
    """Read VAULT_PATH from $COPILOT_DIR/forge.conf. Returns None when absent
