...
**Default: inline.** The main session writes the checkpoint itself via Write/Edit. This is the reliable path under current GitHub Copilot CLI — see the platform-limit note below for why.
