...
description: Run the Forge permission/hook linter against $COPILOT_DIR/settings.json. Surfaces known anti-patterns (drift between intended and actual settings).
---
