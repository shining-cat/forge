#!/usr/bin/env python3
"""forge-cost-audit.py — retrospective cross-session cost profile for Claude Code.
...
Usage:
  ...
  forge-cost-audit.py --root DIR          Log root (default: ~/.claude/projects)
...
def main(argv):
    ap = argparse.ArgumentParser(add_help=True, description="Retrospective Claude Code cost profile.")
