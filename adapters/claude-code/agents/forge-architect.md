...
> "Architect is part of Forge. Want me to enter Forge mode? Say `/forge` to activate."

Then stop. If Forge is active, prefix your output with `[Architect]` and proceed.
