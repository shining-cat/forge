...
- **[docs/obsidian-draft-capture.md](docs/obsidian-draft-capture.md)** — 5-second idea-capture hotkey (Obsidian side)
- **[docs/draft-refinement-protocol.md](docs/draft-refinement-protocol.md)** — how captured drafts turn into proper tasks
